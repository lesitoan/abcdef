      ...
      <div className="bg-card border border-border rounded-lg shadow-lg p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <label htmlFor="fullName" className="block text-xs font-semibold text-foreground uppercase tracking-wider">
              Họ và tên
            </label>
            <Input
              id="fullName"
          ...
          <div className="space-y-2">
            <label htmlFor="confirmPassword" className="block text-xs font-semibold text-foreground uppercase tracking-wider">
              Xác nhận mật khẩu
            </label>
            <Input
              id="confirmPassword"
